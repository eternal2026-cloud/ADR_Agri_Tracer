...
CONFIG.cargar = function () {
  return Promise.all([
    ...
    sb.from('sci_areas').select('*').order('orden').order('nombre')
  ]).then(function (r) {
...
/* ============================================================ ÁREAS · CLIENTE INTERNO */
/**
 * Catálogo propio de áreas de Satisfacción del cliente interno (sci_areas). Auditoría 5S no
